...
<form name="frmEdit" id="frmEdit" method="POST" action="{{ route('admin.vanchuyen.update', ['id' => $vanchuyen->vc_id]) }}">
    <input type="hidden" name="_method" value="PUT"/>
    {{ csrf_field() }}
    <div class="form-group">
        <label for="vc_ten">Tên loại vận chuyển</label>
        <input type="text" class="form-control" name="vc_ten" id="vc_ten" value="{{ old('vc_ten', $vanchuyen->vc_ten) }}">
    </div>
    <div class="form-group">
        <label for="vc_chiPhi">Chi phí</label>
        <input type="text" class="form-control" name="vc_chiPhi" id="vc_chiPhi" value="{{ old('vc_chiPhi', $vanchuyen->vc_chiPhi) }}">
    </div>
    <div class="form-group">
        <label for="vc_dienGiai">Diễn giải</label>
        <input type="text" class="form-control" name="vc_dienGiai" id="vc_dienGiai" value="{{ old('vc_dienGiai', $vanchuyen->vc_dienGiai) }}">
    </div>
    <div class="form-group">
