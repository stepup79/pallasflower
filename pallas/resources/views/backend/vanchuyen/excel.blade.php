    ...
    <div class="row">
        <table border="0" align="center" cellpadding="5" style="border-collapse: collapse;">
            ...
            <tr style="border: 1px thin #000">
                ...
                <td align="left" valign="middle" width="25">{{ $vc->vc_ten }}</td>
                <td align="left" valign="middle" width="15">{{ $vc->vc_chiPhi }}</td>
                <td align="left" valign="middle" width="80">{{ $vc->vc_dienGiai }}</td>
            </tr>
            @endforeach
        </table>
    </div>
