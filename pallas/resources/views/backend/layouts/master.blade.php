...
<head>
  ...
  <!-- ICON -->
  <link rel="shortcut icon" type="image/png" href="{{ asset('storage/img/pallas.png') }}"/>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('frontend.home') }}" class="brand-link">
      <img src="{{ asset('storage/img/pallas.png') }}" alt="Pallas Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
