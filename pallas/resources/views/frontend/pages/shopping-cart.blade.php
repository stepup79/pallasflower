            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="alert alert-danger" ng-show="orderForm.$invalid">
                    <ul>
                        ...
                        <li><span class="error" ng-show="orderForm.dh_ngayGiaoHang.$error.required">Vui lòng nhập thời gian nhận hàng</span></li>
                        ...
                        <li><span class="error" ng-show="orderForm.dh_dienThoai.$error.maxlength">Điện thoại phải <= 11 ký tự</span> </li><!-- Thông báo lỗi dh_loiChuc -->
                        ...
                        <li><span class="error" ng-show="orderForm.dh_loiChuc.$error.maxlength">Lời chúc phải <= 500 ký tự</span> </li> <!-- Thông báo lỗi vc_id -->
                ...
                <div class="form-group">
                    <label for="dh_ngayGiaoHang">Thời gian nhận hàng:</label>
                    <input type="text" class="form-control" id="dh_ngayGiaoHang" name="dh_ngayGiaoHang" ng-model="dh_ngayGiaoHang" ng-required=true>
                </div>
                <div class="form-group">
...
$(function() {
  ...
  $('input[name="dh_ngayGiaoHang"]').daterangepicker({
    singleDatePicker: true,
    showDropdowns: true,
    minYear: 1901,
    maxYear: parseInt(moment().format('YYYY'),10),
        ...
        $scope.submitOrderForm = function() {
            ...
            if ($scope.orderForm.$valid) {
                ...
                var dataInputOrderForm_DatHang = {
                    "dh_ngayGiaoHang": $scope.orderForm.dh_ngayGiaoHang.$viewValue,
