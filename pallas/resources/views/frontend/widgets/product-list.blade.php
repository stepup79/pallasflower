	...
	<div class="container">
		...
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-16 m-tb-5 how-active1" data-filter="*">
					<div class="btn btn-outline-secondary">Tất cả</div>
				</button>																			
				@foreach($danhsachchude as $chude)										
						<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-16 m-tb-5" data-filter=".loai-{{ $chude->cd_id }}">
							<div class="btn btn-outline-secondary">{{ $chude->cd_ten }}</div>
						</button>
				@endforeach									
			</div>			
		</div>
