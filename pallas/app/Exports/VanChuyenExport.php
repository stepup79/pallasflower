...
class VanChuyenExport implements FromView, WithDrawings, WithEvents, ShouldAutoSize
{
    use Exportable, RegistersEventListeners;

    public function view(): View
    {
        return view('backend.vanchuyen.excel', [
    ...
    */
    public static function afterSheet(AfterSheet $event)
    {
        ...
        // Format dòng tiêu đề
        $event->sheet->getDelegate()->getStyle('A5:D5')->applyFromArray(
            [
                'font' => [
                    'bold' => true,
                ],
        ...
        foreach($dsVanchuyen as $index=>$vc)
        {
