...
class DonHangExport implements FromView, WithDrawings, WithEvents, ShouldAutoSize
{
    use Exportable, RegistersEventListeners;

    public function view(): View
    {
        return view('backend.donhang.excel', [
    ...
    */
    public static function afterSheet(AfterSheet $event)
    {
        ...
        $event->sheet->getDelegate()->getStyle('A6:L6')->applyFromArray(
            [
                'font' => [
                    'bold' => true,
                ],
        ...
        foreach($dsDonhang as $index=>$donhang)
        {
            ...
            $coordinate = "A${currentRow}:L${currentRow}";
