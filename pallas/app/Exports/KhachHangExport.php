...
class KhachHangExport implements FromView, WithDrawings, WithEvents, ShouldAutoSize
{
    use Exportable, RegistersEventListeners;

    public function view(): View
    {
        return view('backend.khachhang.excel', [
    ...
    */
    public static function afterSheet(AfterSheet $event)
    {
        ...
        $event->sheet->getDelegate()->getStyle('A1:I3')->applyFromArray(
            [
                'font' => [
                    'bold' => true,
                ],
        ...
        // Format dòng tiêu đề
        $event->sheet->getDelegate()->getStyle('A5:I5')->applyFromArray(
            [
                'font' => [
                    'bold' => true,
                ],
        ...
        foreach($dsKhachhang as $index=>$khachhang)
        {
